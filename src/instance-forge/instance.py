...
class Instance:
    ...
    def _create_instance_parameters(self) -> None:
        ...
        makespan_estimation: int = math.ceil(num_jobs * average_processingtime/num_centers)
        ...
        for j in range(num_jobs):
            ...
            release_time = float(time_rand.randint(0, math.ceil(
            ...
            due_date = (float(math.ceil(duedate_estimation + time_rand.randint(0, math.ceil(makespan_estimation*0.19)))),
                        float(time_rand.randint(2, 7))) if self._instance_environment.is_due else None
            deadline_estimation = (
            ...
            for center in self.centers:
                ...
                for idx, op in enumerate(operations):
                    if not is_eligible:
                        machine: Optional[Machine] = machines[job.sequence[idx]] if job.sequence else None
